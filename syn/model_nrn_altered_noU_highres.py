...
ks[347] = 22.3                  # PDE1ACaMCa4 + cAMP <-> PDE1ACaMCa4cAMP (forward)
...
ks[355] = 22.3                  # PDE1ApCaMCa4 + cAMP <-> PDE1ApCaMCa4cAMP (forward)
...
if myonset > max(tvec):
  myonset = 0
interptimes = [myonset + 500*i for i in range(-1,int((max(tvec)-myonset)/500))]
if interptimes[0] < 0:
...
filename = 'nrnhighres_tstop'+str(Duration)+'_tol'+str(tolerance)+addition+'_onset'+str(Ca_input_onset)+'_n'+str(Ca_input_N)+'_freq'+str(Ca_input_freq)+'_dur'+str(Ca_input_dur)+'_flux'+str(Ca_input_flux)+'_Lflux'+str(L_input_flux)+'_Gluflux'+str(Glu_input_flux)+'_AChflux'+str(ACh_input_flux)+'_Ntrains'+str(Ntrains)+'_trainT'+str(trainT)+'.mat'
