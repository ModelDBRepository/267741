...
if Ca_input_freq == 1.0:
  l23pc_filename = '../l23pc/currClips'+str(icell_l23pc-1)+'_imutCMcomb'+str(imut_l23pc)+'_neckLen0.5_neckDiam0.1_stimfreq'+str(Ca_input_freq)+'_pulseamp'+str(pulseamp)+'_Nsyn'+str(Nsyn_l23pc)+'_Ninputs1'+location_l23pc+'_Econ'+str(Econ_l23pc)+'_wNMDA'+str(wNMDA_l23pc)+'_gNap'+str(gNap_l23pc)+'_Npulses'+str(Npulses)+'_ISI'+str(pairingISI)+'.mat'
  for addit in ['b','c','d','e','f','g','h']:
    if exists(l23pc_filename):
      break
    l23pc_filename = '../l23pc'+addit+'/currClips'+str(icell_l23pc-1)+'_imutCMcomb'+str(imut_l23pc)+'_neckLen0.5_neckDiam0.1_stimfreq'+str(Ca_input_freq)+'_pulseamp'+str(pulseamp)+'_Nsyn'+str(Nsyn_l23pc)+'_Ninputs1'+location_l23pc+'_Econ'+str(Econ_l23pc)+'_wNMDA'+str(wNMDA_l23pc)+'_gNap'+str(gNap_l23pc)+'_Npulses'+str(Npulses)+'_ISI'+str(pairingISI)+'.mat'
