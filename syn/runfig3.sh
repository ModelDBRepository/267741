...
TRAINISIS=(-120.0 -100.0 -80.0 -60.0 -50.0 -40.0 -30.0 -25.0 -20.0 -15.0 -10.0 -5.0 -2.5 0.0 2.5 5.0 10.0 15.0 20.0 25.0 30.0 40.0 50.0 60.0 80.0 100.0 120.0 140.0)
pulseamp=10.0
Nsyn=1
LOC=apic250-300
...
do
  ...
  do
    ...
    do
	if [[ -f nrn_tstop25840000_${BLOCKED},${EXTRABLOCKED}x${BLOCKEDCOEFF},${EXTRABLOCKEDCOEFF}_n120_freq1.0_dur3.0_Lflux${LFLUX}_Gluflux0.0_AChflux${ACHFLUX}_Ntrains1_trainT100000.0_pair${ISI}_icell1_pulseamp10.0_Nsyn1_Econ0.00015_wNMDA1.0_gNap0.03_Npulses4_apic250-300.mat ||
 	      -f nrn_tstop25840000_${BLOCKED},${EXTRABLOCKED}x${BLOCKEDCOEFF},${EXTRABLOCKEDCOEFF}_onset24040000.0_n120_freq1.0_dur3.0_Lflux${LFLUX}_Gluflux0.0_AChflux${ACHFLUX}_Ntrains1_trainT100000.0_pair${ISI}_icell1_pulseamp10.0_Nsyn1_Econ0.00015_wNMDA1.0_gNap0.03_Npulses4_apic250-300.mat ]]
      then
  ...
  do
    if [ -f nrn_tstop25840000_${BLOCKED},${EXTRABLOCKED}x${BLOCKEDCOEFF},${EXTRABLOCKEDCOEFF}_n120_freq1.0_dur3.0_Lflux${LFLUX}_Gluflux0.0_AChflux${ACHFLUX}_Ntrains1_trainT100000.0_pair${ISI}_icell1_imutc${imut}_pulseamp10.0_Nsyn1_Econ0.00015_wNMDA1.0_gNap0.03_Npulses4_apic250-300.mat ]
    then
      echo "nrn_tstop25840000_${BLOCKED},${EXTRABLOCKED}x${BLOCKEDCOEFF},${EXTRABLOCKEDCOEFF}_n120_freq1.0_dur3.0_Lflux${LFLUX}_Gluflux0.0_AChflux${ACHFLUX}_Ntrains1_trainT100000.0_pair${ISI}_icell1_imutc${imut}_pulseamp10.0_Nsyn1_Econ0.00015_wNMDA1.0_gNap0.03_Npulses4_apic250-300.mat exists"
    else
      echo "nrn_tstop25840000_${BLOCKED},${EXTRABLOCKED}x${BLOCKEDCOEFF},${EXTRABLOCKEDCOEFF}_n120_freq1.0_dur3.0_Lflux${LFLUX}_Gluflux0.0_AChflux${ACHFLUX}_Ntrains1_trainT100000.0_pair${ISI}_icell1_imutc${imut}_pulseamp10.0_Nsyn1_Econ0.00015_wNMDA1.0_gNap0.03_Npulses4_apic250-300.mat does not exist"	
      echo "python3 model_nrn_paired_withNap_contnm_var_npulses_mutcs_extfilename.py 25840000 1e-6 24040000 120 1.0 3 1.0 0.05 0.0 0.05 1 100000 $ISI 1 $Econ $wNMDA $gNap $imut $Npulses $pulseamp $LOC $Nsyn None 23560000 600000 ${BLOCKED},${EXTRABLOCKED} ${BLOCKEDCOEFF},${EXTRABLOCKEDCOEFF}"
      python3 model_nrn_paired_withNap_contnm_var_npulses_mutcs_extfilename.py 25840000 1e-6 24040000 120 1.0 3 1.0 0.05 0.0 0.05 1 100000 $ISI 1 $Econ $wNMDA $gNap $imut $Npulses $pulseamp $LOC $Nsyn None 23560000 600000 ${BLOCKED},${EXTRABLOCKED} ${BLOCKEDCOEFF},${EXTRABLOCKEDCOEFF}
    fi
  done
  ...
  do
    imut=$icomb
    extfilename=nrn_paired_imutCMcomb${imut}_comb-1_${Econ}_${wNMDA}_gNap${gNap}_pulseamp${pulseamp}_${ISI}.mat
    if [ -f $extfilename ]
    then
  ...
  do
    ...
    extfilename=nrn_paired_imutCMcomb-1_comb${iextra}_${Econ}_${wNMDA}_gNap${gNap}_pulseamp${pulseamp}_${ISI}.mat
    if [ -f $extfilename ]
    then
      echo "$extfilename exists"
    else
  ...
  do
    ...
    EXTRABLOCKED=${EXTRABLOCKEDS[iextra]}
    EXTRABLOCKEDCOEFF=${EXTRABLOCKEDCOEFFS[iextra]}
   extfilename=nrn_paired_imutCMcomb${imut}_comb${iextra}_${Econ}_${wNMDA}_gNap${gNap}_pulseamp${pulseamp}_${ISI}.mat
    if [ -f $extfilename ]
    then
      echo "$extfilename exists"
    else
